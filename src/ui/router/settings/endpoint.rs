...
use crate::{
    ...
    ui::{
        ICMsg, ToCmdMsg, ToOutMsg, components::icons,
        router::settings::endpoint::Out::RemoveEndpoint,
    },
};
...
pub struct Endpoint {
    ...
    pub endpoint: Option<Arc<dyn IndexableEndpoint + Send + Sync>>,
...
pub enum Cmd {
    ...
    TestEndpoint,
    TestRes(Result<Arc<dyn IndexableEndpoint + Send + Sync>, Error>),
}
                ...
                Some(EndpointType::Jellyfin) => {
                    ...
                    Task::perform(
                        (async move || {
                            ...
                            Ok(Arc::new(jf) as Arc<dyn IndexableEndpoint + Send + Sync>)
                        })(),
